...
class WireShield(models.Model):
	...
	meb_value=models.IntegerField(verbose_name="MEB值",blank=True,null=True)
	leb_des=models.CharField(verbose_name="LEB描述",max_length=50,blank=True,null=True)
	leb_value=models.IntegerField(verbose_name="LEB描述",blank=True,null=True)
	...
	equipment_ground_star=models.IntegerField(verbose_name="设备接地",choices=COMMENT_START,blank=True,null=True)
	shelf_ground_start=models.IntegerField(verbose_name="机柜接地",choices=COMMENT_START,blank=True,null=True)
	earth_wire_star=models.IntegerField(verbose_name="地线长度/颜色/线径综合评定",choices=COMMENT_START,blank=True,null=True)
	misc_star=models.IntegerField(verbose_name="铠(屏蔽)层/光缆钢芯、冗余线、金属管道、消防柜、电池柜",choices=COMMENT_START,blank=True,null=True)
...
class Lightning_Receptor(models.Model):
	...
	resistance=models.IntegerField(verbose_name='接地电阻',blank=True,null=True)
	...
	check_result=models.IntegerField(verbose_name='检查结论',choices=CHECK_RESULT,blank=True,null=True)
	atmb=models.ForeignKey(Atmb, on_delete=models.CASCADE)
...
class Down_Lead_Line(models.Model):
	...
	resistance=models.IntegerField(verbose_name='接地电阻',blank=True,null=True)
	quantity=models.IntegerField(verbose_name='数量',blank=True,null=True)
	distance_away_cable=models.IntegerField(verbose_name='与电缆水平距离',choices=CABLE_DISTANCE_OPERATOR,blank=True,null=True)
	cable_quantity=models.IntegerField(verbose_name='1米',blank=True,null=True)
	check_result=models.IntegerField(verbose_name='检查结论',choices=CHECK_RESULT,blank=True,null=True)
	atmb=models.ForeignKey(Atmb, on_delete=models.CASCADE)

EARTH_DEVICE_MODE=((0,'自然接地体'),(1,'人工接地体'),(2,'联合接地装置'))
class Earth_Device(models.Model):
	mode=models.IntegerField(verbose_name='形式',choices=EARTH_DEVICE_MODE,blank=True,null=True)
...
class Power_SPD(models.Model):
	category=models.IntegerField(verbose_name='类别',choices=SPD_CATEGORY,blank=True,null=True)
